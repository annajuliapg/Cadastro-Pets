...
int main ()
{
    ...
    int num_id=0; // variavel para dar números aos registros, não é modificada ao retirar um cadastro

    // inicialmente o id é 0 pois não há registros ainda
    ...
    do
    {
        ...
        switch (menu)
        {
            case 1:
            clrscr();
            novo_cadastro(&inicio, &cont_total, &num_id);
            break;
